...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_xbar_0.tcl
