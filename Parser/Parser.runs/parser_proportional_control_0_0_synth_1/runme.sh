...
HD_PWD='C:/Users/marko/MD/MeteorDestroyer/Parser/Parser.runs/parser_proportional_control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_proportional_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_proportional_control_0_0.tcl
