...
HD_PWD='C:/Users/Muaz/Documents/MeteorDestroyer/Parser/Parser.runs/parser_object_localizer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_object_localizer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_object_localizer_1_0.tcl
