...
HD_PWD='D:/VivadoPrj/Nexys-all-Projects/NVideoHDMI-22.1u/hw/hw/hw.runs/hdmi_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_xbar_2.tcl
