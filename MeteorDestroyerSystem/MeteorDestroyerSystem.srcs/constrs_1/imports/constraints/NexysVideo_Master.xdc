...
# set_property PACKAGE_PIN V8 [get_ports trig]
# set_property IOSTANDARD LVCMOS33 [get_ports trig]
# set_property PACKAGE_PIN V9 [get_ports {echo[0]}]
# set_property PACKAGE_PIN W7 [get_ports {echo[1]}]
# set_property PACKAGE_PIN V7 [get_ports {echo[2]}]
# set_property PACKAGE_PIN Y9 [get_ports {echo[3]}]
# set_property PACKAGE_PIN W9 [get_ports {echo[4]}]
# set_property PACKAGE_PIN Y7 [get_ports {echo[5]}]
# set_property PACKAGE_PIN Y8 [get_ports {echo[6]}]
...
# set_property IOSTANDARD LVCMOS33 [get_ports pwm_pan]
# set_property IOSTANDARD LVCMOS33 [get_ports pwm_tilt]
# set_property PACKAGE_PIN AA6 [get_ports {echo[7]}]
# set_property PACKAGE_PIN Y6 [get_ports {echo[8]}]
# set_property PACKAGE_PIN AB8 [get_ports {echo[9]}]
# set_property PACKAGE_PIN AA8 [get_ports {echo[10]}]
# set_property PACKAGE_PIN T6 [get_ports {echo[11]}]
# set_property PACKAGE_PIN AB22 [get_ports pwm_tilt]
# set_property PACKAGE_PIN AB21 [get_ports pwm_pan]
